...
#import "Lession7_2Board.h"

#pragma mark -

@implementation Lession7_2Board
...
- (void)handleUISignal:(BeeUISignal *)signal
{
	...
	if ( [signal isKindOf:BeeUIBoard.SIGNAL] )
	{
		if ( [signal is:BeeUIBoard.CREATE_VIEWS] )
		{
			...
			[_button1 addSignal:Lession7_2Board.SHOW forControlEvents:UIControlEventTouchUpInside];
			...
			[_button2 addSignal:Lession7_2Board.HIDE forControlEvents:UIControlEventTouchUpInside];
	...
	else if ( [signal is:Lession7_2Board.SHOW] )
	{
		[_indicator startAnimating];
	}
	else if ( [signal is:Lession7_2Board.HIDE] )
	{
