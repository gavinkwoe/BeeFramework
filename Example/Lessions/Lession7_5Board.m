...
#import "Lession7_5Board.h"

#pragma mark -

@implementation Lession7_5Board
...
- (void)handleUISignal:(BeeUISignal *)signal
{
	...
	if ( [signal isKindOf:BeeUIBoard.SIGNAL] )
	{
		if ( [signal is:BeeUIBoard.CREATE_VIEWS] )
		{
			...
			[_button addSignal:Lession7_5Board.BUTTON_TOUCHED forControlEvents:UIControlEventTouchUpInside];
	...
	else if ( [signal is:Lession7_5Board.BUTTON_TOUCHED] )
	{
		BeeUIDatePicker * picker = [BeeUIDatePicker spawn];
		picker.date = [NSDate date];
		[picker presentForController:self];
	}	
	else if ( [signal isKindOf:BeeUIDatePicker.SIGNAL] )
	{
