...
#import "Lession9Board.h"
#import "Lession9Controller.h"
#import "JSONKit.h"

#pragma mark -

@implementation Lession9Board
...
- (void)handleUISignal_Lession9Board:(BeeUISignal *)signal
{
	...
	if ( [signal is:Lession9Board.BUTTON1_TOUCHED] )
	{
		...
		{
			[self cancelMessage:Lession9Controller.LOCAL];
		}
		else
		{
			[self sendMessage:Lession9Controller.LOCAL timeoutSeconds:10.0f];
		}
	}
	else if ( [signal is:Lession9Board.BUTTON2_TOUCHED] )
	{
		if ( [self sendingMessage:Lession9Controller.REMOTE] )
		{
			[self cancelMessage:Lession9Controller.REMOTE];
		}
		else
		{
			[[self sendMessage:Lession9Controller.REMOTE timeoutSeconds:10.0f] input:
...
- (void)handleMessage_Lession9Controller:(BeeMessage *)msg
{
	...
	else if ( [msg is:Lession9Controller.REMOTE] )
	{
		if ( msg.sending )
		{
