...
#import "Lession7_3Board.h"

#pragma mark -

@implementation Lession7_3Board
...
- (void)handleUISignal_Lession7_3Board:(BeeUISignal *)signal
{
	...
	if ( [signal is:Lession7_3Board.BUTTON_TOUCHED] )
	{
		...
		[alert addButtonTitle:@"Button 1" signal:Lession7_3Board.ALERT_ITEM1_TOUCHED];
		[alert addButtonTitle:@"Button 2" signal:Lession7_3Board.ALERT_ITEM2_TOUCHED];
		[alert addCancelTitle:@"Close"];
		[alert presentForController:self];
	}	
	else if ( [signal is:Lession7_3Board.ALERT_ITEM1_TOUCHED] )
	{
		BeeUIAlertView * alert = (BeeUIAlertView *)signal.source;
		[alert dismissAnimated:YES];
	}
	else if ( [signal is:Lession7_3Board.ALERT_ITEM2_TOUCHED] )
	{
		BeeUIAlertView * alert = (BeeUIAlertView *)signal.source;
		[alert dismissAnimated:YES];		
	}
