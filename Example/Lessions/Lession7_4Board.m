...
#import "Lession7_4Board.h"

#pragma mark -

@implementation Lession7_4Board
...
- (void)handleUISignal:(BeeUISignal *)signal
{
	...
	if ( [signal isKindOf:BeeUIBoard.SIGNAL] )
	{
		if ( [signal is:BeeUIBoard.CREATE_VIEWS] )
		{
			...
			[_button addSignal:Lession7_4Board.BUTTON_TOUCHED forControlEvents:UIControlEventTouchUpInside];
	...
	else if ( [signal is:Lession7_4Board.BUTTON_TOUCHED] )
	{
		// TODO:
	}	
}
